...
<html lang="zxx">
<head>
    <title>Recep Utku Bahçıvan</title>
...
<body>
    <div class="sidenav text-center">
		<div class="side_top">
			<img src="web/images/abou.jpg" style="width:200px;height: 250px" alt="news image" class="img-fluid navimg">
			<h1 class="top_hd mt-2"><a href="index.html">Recep Utku Bahçıvan</a></h1>
			<p class="top_hdp mt-2">Bilişim Sistemleri Mühendisi</p>
        </div>
		<!-- header -->
        <header>
			<div class="nav-top">
...
<section class="services" id="services">
	<div class="container">
		...
		<p class="iner mt-md-5 text-left"> Eğitim hayatım boyunca kullanmış ya da denemiş olduğum teknolojileri aşağıda listelemekteyim. Birçok alanda birçok teknoloji deneme fırsatım oldu. </p>
	...
	<h3 class="w3_head mb-4 text-left"> İletişim</h3>
		<div class="contact_grid_right mt-5 mx-auto text-left">
			...
			<div class="cpy-right text-center">
				<p>© 2023 Conjoint. All rights reserved | Design by
